...
const Login = () => {
  ...
  if (!session) {
    return (
      <section className="bg-gray-50 mt-24 sm:py-8">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="text-center">
                      <p className="text-base text-gray-600">
                        ...
                        <div
                          // href="/v1/auth/signup"
                          className="font-medium text-orange-500 transition-all cursor-pointer duration-200 hover:text-orange-600 hover:underline"
                          onClick={login}
                        >
                         Sign in with Google
                        </div>
